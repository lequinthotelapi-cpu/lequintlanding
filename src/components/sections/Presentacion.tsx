...
import { Handshake, MapPin, WifiHigh } from "@phosphor-icons/react/dist/ssr";
...
export function Presentacion() {
  return (
    <section aria-labelledby="presentacion-heading" className="border-b border-line py-20 sm:py-28 lg:py-36">
      <div className="mx-auto grid max-w-[1240px] grid-cols-1 items-center gap-10 px-5 sm:px-8 lg:grid-cols-[1fr_1.05fr] lg:gap-16">
        <Reveal>
        ...
        <Reveal delayMs={100}>
          <div className="relative aspect-[3/2] overflow-hidden bg-stone lg:aspect-[4/3.3]">
            <Parallax strength={0.08}>
              <Image
                src={recepcion}
                alt="Recepción de Le Quint Hotel, con el gato del hotel sobre el mostrador"
                fill
